...
public class finaldsa 
{
	...
	{ 
		...
		FileReader file = new FileReader("bookName.txt");			
		BufferedReader reader = new BufferedReader(file);	
		
		FileReader file2= new FileReader("totalQuantity.txt");			
		BufferedReader reader2 = new BufferedReader(file2);	
		
		FileReader file3= new FileReader("remainingQuantity.txt");			
